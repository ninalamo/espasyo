...
const TrendAnalysis: React.FC<Props> = ({ historicalData, forecastData }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Comprehensive Legend and Data Explanation */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-sm">
            ...
            <div>
              ...
              <div className="space-y-1 text-green-800">
                <div>• <strong>Avg Confidence:</strong> {analysis.overallStats.avgConfidence ? (analysis.overallStats.avgConfidence * 100).toFixed(1) : 'N/A'}%</div>
                <div>• <strong>Data Points:</strong> {analysis.overallStats.totalForecasts || 0}</div>
