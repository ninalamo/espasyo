  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-ubuntu-50 border border-blue-200 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              <h5 className="font-medium text-ubuntu-700 mb-3">Symbol Meanings</h5>
            ...
            <div>
              <h5 className="font-medium text-ubuntu-700 mb-3">Number Interpretation</h5>
