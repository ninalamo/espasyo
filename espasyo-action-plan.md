...
- [ ] **P1-1a** Create `AnalysisRun` entity
...
- [ ] **P1-1b** Create `IAnalysisRunRepository` + implementation
  - _File:_ `nin-architecture/espasyo.Application/Interfaces/IAnalysisRunRepository.cs` (new)
  - _File:_ `nin-architecture/espasyo.Infrastructure/Data/Repositories/AnalysisRunRepository.cs` (new)
  - _File:_ `nin-architecture/espasyo.Infrastructure/Data/Repositories/Sqlite/SqliteAnalysisRunRepository.cs` (new)
  - _AC:_ Full CRUD: Save, GetById, GetAll, Delete with pagination

- [ ] **P1-1c** Create EF Core migration
  - _AC:_ `dotnet ef migrations add CreateAnalysisRun` succeeds for both SQL Server and SQLite contexts

- [ ] **P1-1d** Create `AnalysisRunController` API endpoints
  - _File:_ `nin-architecture/espasyo.WebAPI/Controllers/AnalysisRunController.cs` (new)
...
- [ ] **P1-2a** Create `ManpowerRecommendation` entity
  - _File:_ `nin-architecture/espasyo.Domain/Entities/ManpowerRecommendation.cs` (new)
...
- [ ] **P1-2b** Create `IManpowerRecommendationRepository` + implementation + migration
  - _AC:_ Full CRUD, migration runs cleanly
